...
function Homepagebanner() {
  ...
  const getbannerimg = async () => {
    let res = await axios.get("http://localhost:8080/api/userapp/getallhomebanner");
    if ((res.status = 200)) {
  ...
  const deletebannerimg = async (id) => {
    axios({
      method: "post",
      url: "http://localhost:8080/api/userapp/deletehomebanner/" + id,
    })
                        ...
                        <tr key={i}>
                          ...
                          <td>
                            <img
                              ...
                              src={`http://localhost:8080/homepagebanner/${element.banner}`}
                              width={"100px"}
                              height={"50px"}
                            />
                          </td>
